...
export const projects: Project[] = [
  {
    ...
    // TODO: this description still references "The Coche Events" — copy-paste leftover, needs its own text
    ...
    tags: [ "React", "Node.js", "Tailwind", "JavaScript" ],
    link: "https://gillian-gutierrez.vercel.app"
  },
  {
