        ...
        <div className="relative w-full">
            ...
            >
                ...
                <div className="relative order-1 h-[60vh] min-h-[340px] w-full lg:order-2 lg:flex lg:h-auto lg:w-auto lg:-translate-x-10 lg:flex-col lg:items-center xl:-translate-x-20">
                    <div className="relative h-full w-full overflow-hidden lg:mx-auto lg:h-[460px] lg:w-[350px] lg:rounded-[2rem] [@media(min-width:1024px)_and_(max-height:700px)]:h-[300px] [@media(min-width:1024px)_and_(max-height:700px)]:w-[220px]">
                        <Image
                            src="/image1.png"
                            alt="Alleah Bayas"
                            fill
                ...
                <div className="relative order-2 -mt-16 flex flex-col items-center overflow-hidden px-6 pb-8 pt-0 lg:order-1 lg:mt-0 lg:max-w-sm lg:items-start lg:overflow-visible lg:bg-transparent lg:px-0 lg:py-0 xl:max-w-xl">
                    ...
                    <h1 className="mt-3 font-inter text-4xl font-semibold leading-tight text-white sm:text-6xl lg:mt-6 lg:text-7xl lg:leading-none [@media(min-width:1024px)_and_(max-height:700px)]:mt-4 [@media(min-width:1024px)_and_(max-height:700px)]:text-4xl [@media(min-width:1024px)_and_(max-height:700px)]:leading-tight">
                        Hello! I'm{" "}
                    ...
                    <p className="mt-3 max-w-xl font-inter text-[12px] leading-[1.6] text-[#CFCFCF] sm:text-[15px] lg:mt-8 lg:text-[18px] lg:leading-[1.7] [@media(min-width:1024px)_and_(max-height:700px)]:mt-4 [@media(min-width:1024px)_and_(max-height:700px)]:text-[14px] [@media(min-width:1024px)_and_(max-height:700px)]:leading-[1.5]">
                    ...
                    <div className="relative mt-6 flex w-full flex-col items-center gap-3 sm:flex-row sm:justify-center lg:mt-6 lg:justify-start lg:gap-4 xl:mt-12 xl:gap-6">
                        <a
                            href="#projects"
                            className="flex w-full max-w-xs items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#FB0945] via-[#FF5C8D] to-[#FFE3CD] px-8 py-4 font-inter font-semibold text-black transition hover:scale-[1.02] sm:w-auto [@media(min-width:1024px)_and_(max-height:700px)]:px-6 [@media(min-width:1024px)_and_(max-height:700px)]:py-3 [@media(min-width:1024px)_and_(max-height:700px)]:text-sm"
                        >
                            View My Work
                            <span>→</span>
                        </a>
